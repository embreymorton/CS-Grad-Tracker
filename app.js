...
if (process.env.mode == "production" || process.env.mode == "development") {
              ...
              .then(function (result) {
                if (result != null) {
                  ...
                  res.render("./error.ejs", {
                    string:
                      "Failed Authentication, you are not a user in the database",
                  });
                }
              });
          }
  ...
  app.get("/student", (req, res) => {
    res.render("student/index", {
      cache: false, // This disables EJS caching for this request
      students: studentData,
    });
  });

  const email = require("./controllers/email.js");
  app.get("/etherealEmail", (req, res) => {
    // special testing-only route that returns a JSON of testAccount credentials
