...
const { dropdown, makeOption, optionSet, script, dateInput, checkbox } =
  baseComponents;
...
const mainContent = (opts) => {
  ...
  const form = !hasAccess ? div("You do not have access") : cs01FormNEW(opts);
  return [
  ...
  return renderCard(
    ...
    x("form.cs-form#cs-form")(
      ...
      x(".text-center")(
        ...
        strong(
          "The worksheet is a component of the Program of Study for MS (CS-03) and/or PhD (CS-06)."
        )
      ),
      hr(),
  ...
  return [
    row(
      ...
      colMd(8)(
        ...
        row(colMd(12)({ id: "coveredLine" }, hr())),
        ...
        gRow(
          { id: `${key}CourseCovered` },
          colMd(6)(
            div(
              "If not from UNC, list the school and course that covers this requirement:"
            ),
            ...
            dropdown(
              ...
              faculty.map((faculty) =>
                makeOption(
                  faculty.lastFirst,
                  faculty.lastFirst,
                  values[descriptionFieldName] == faculty.lastFirst
                )
              ),
              {
                isDisabled: true,
        ...
        gRow(
          { id: `${key}WaiverCovered` },
          colMd(12)(
            div("Has CS-02 form been submitted?"),
            checkbox(
              descriptionFieldName,
              values[descriptionFieldName] == "CS-02 Is Submitted",
              cspNonce,
              {
