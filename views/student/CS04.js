...
const mainContent = (opts) => {
  ...
  const form = !hasAccess ? div("You do not have access") : cs04Form(opts);
  return [
      ...
      x("form.cs-form#cs-form")(
        ...
        row(
          colMd(6)(
            ...
            textarea("projectDescription", form.projectDescription, {
              isRequired: true,
        ...
        row(
          colMd(6)(
            ...
            textarea("publication", form.publication, {
              isRequired: true,
              isDisabled: disabled.disabled,
              rows: 1,
            })
        ...
        row(
          colMd(4)(
            ...
            dateInput("publicationDate", form.publicationDate, {
        ...
        row(
          colMd(6)(
            ...
            input("attachmentURL", form.attachmentURL, {
          ...
          colMd(6)(
            ...
            dropdown(
              ...
              [
                makeOption(
                  false,
                  "No. The documentation is attached.",
                  !form.docProprietary
                ),
                makeOption(
                  true,
                  "Yes. A non-disclosure agreement is attached.",
                  form.docProprietary
                ),
              ],
        ...
        div(
          { class: "text-center" },
          b("(Below is to be completed by the advisor.)")
        ),
        hr(),
        ...
        row(
          colMd(12)(
            div(
              "The majority of the publication was completed by the student:"
            ),
            checkbox("majorityCompleted", form.majorityCompleted, cspNonce, {
        ...
        row(
          colMd(12)(
            div(
              "The student has revised the externally reviewed publication such that it also satisfies the Comprehensive Writing requirement (e.g., extending the related work section to be broad and detailed):"
            ),
            checkbox(
