...
const mainContent = (opts) => {
  ...
  return [
    ...
    div(
      ...
      p(
        "Please complete this form to record your research discussion with three or more potential doctoral committee members. Ensure each member signs below."
      ),
      hr(),
      form
    ),
...
const cs12Form = (opts) => {
  const { postMethod, student, form, isStudent, admin, isComplete, cspNonce } =
    opts;
  ...
  return renderCard(
    ...
    x("form.cs-form#cs-form")(
      ...
      namePidRow({ lastName, firstName, pid, email }),
      hr(),
      p("Date of Research Discussion:"),
      dateInput("discussionDate", form.discussionDate, {
        isRequired: true,
        placeholder: "MM-DD-YYYY",
      }),
      hr(),
      h3(
        strong("Committee Members Names & Signatures (Enter at least 3):"),
        x(".verticalSpace")()
      ),
      ...
      ...Array.from({ length: 6 }, (_, i) => [
        ...
        row(
          colMd(6)(
            ...
            input(
              "text",
              `committeeMember${i + 1}Name`,
              form[`committeeMember${i + 1}Name`] || "",
          ...
          colMd(6)(
            ...
            input(
              "text",
              `committeeMember${i + 1}Signature`,
              form[`committeeMember${i + 1}Signature`] || "",
      ...
      p(strong("Notes:")),
      div({ class: "text-center" }, "Target Deadline: Semester 5"),
      div({ class: "text-center" }, "Final Deadline: Semester 6"),
      hr(),
...
const namePidRow = ({ lastName, firstName, pid, email }) => {
  ...
  return row(
    ...
    colMd(6)(div("Email"), pseudoInput(email))
  );
};
