  ...
  return [
    ...
    div(
      ...
      x('p.underline.text-center')(
        br(), strong('Complete only the section that is most appropriate for your Program Product Requirement.'), br(), br(), h3('You can expand the section most relevant to you by clicking on the title.'),
      ),
      cs13Form(opts),
    )
  ]
