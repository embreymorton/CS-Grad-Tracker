  ...
  return [
    ...
    div(
      ...
      x('p.underline.text-center')(
        br(), strong('Complete only the section that is appropriate for your Program Product Requirement.'), br(),strong('You can expand the section relevant to you by clicking on the title.'),
      ),
      cs13Form(opts),
    )
  ]
